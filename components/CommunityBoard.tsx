  ...
  return (
    <div className="w-full flex flex-col items-center animate-soft-in h-full relative">
        ...
        <div className="text-center mb-6">
            <h2 className="text-3xl font-bold text-stone-800 serif-font tracking-tight italic">時光心聲長廊</h2>
            <div className="flex items-center justify-center gap-3 mt-2">
                 ...
                 <button onClick={onRefresh} className={`p-1 transition-all ${isSyncing ? 'animate-spin text-amber-500' : 'text-stone-300'}`}>
                    <RefreshCw size={14} />
                 </button>
            </div>
        </div>
            ...
            {filteredLogs.length === 0 ? (
                ...
                <div className="flex flex-col gap-6 px-2 animate-soft-in">
                    {filteredLogs.map((log) => (
                        ...
                        >
                            {/* 裝飾水印 */}
                            <div className="absolute -top-2 -right-2 opacity-50 group-hover:scale-110 transition-transform pointer-events-none">
